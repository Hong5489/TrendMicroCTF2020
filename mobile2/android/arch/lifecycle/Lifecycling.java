...
public class Lifecycling {
  ...
  private static Map<Class, Integer> sCallbackCache = (Map)new HashMap<>();
  
  private static Map<Class, List<Constructor<? extends GeneratedAdapter>>> sClassToAdapters = (Map)new HashMap<>();
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/arch/lifecycle/Lifecycling.class
