...
public abstract class LiveData<T> {
  ...
  private final Runnable mPostValueRunnable = new Runnable() {
      public void run() {
        Object object2;
        Object object1 = LiveData.this.mDataLock;
        /* monitor enter ClassFileLocalVariableReferenceExpression{type=ObjectType{java/lang/Object}, name=null} */
        try {
          object2 = LiveData.this.mPendingData;
          try {
  ...
  protected void postValue(T paramT) {
    ...
    boolean bool = false;
    try {
      Object object1 = this.mPendingData;
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/arch/lifecycle/LiveData.class
