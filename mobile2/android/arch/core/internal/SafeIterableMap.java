...
public class SafeIterableMap<K, V> implements Iterable<Map.Entry<K, V>> {
  ...
  public Iterator<Map.Entry<K, V>> descendingIterator() {
    DescendingIterator<K, V> descendingIterator = new DescendingIterator<>(this.mEnd, this.mStart);
  ...
  public Iterator<Map.Entry<K, V>> iterator() {
    AscendingIterator<K, V> ascendingIterator = new AscendingIterator<>(this.mStart, this.mEnd);
  ...
  protected Entry<K, V> put(K paramK, V paramV) {
    Entry<K, V> entry2 = new Entry<>(paramK, paramV);
    this.mSize++;
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/arch/core/internal/SafeIterableMap.class
