...
public class ConstraintSet {
  ...
  public void removeFromHorizontalChain(int paramInt) {
    if (this.mConstraints.containsKey(Integer.valueOf(paramInt))) {
      ...
      int k = constraint.startToEnd;
      j = constraint.endToStart;
      if (k != -1 || j != -1)
        if (k != -1 && j != -1) {
          connect(k, 7, j, 6, 0);
          connect(j, 6, i, 7, 0);
          ...
          if (constraint.rightToRight != -1) {
            ...
            connect(j, 6, constraint.leftToLeft, 6, 0);
          } 
        }  
      clear(paramInt, 6);
      clear(paramInt, 7);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/constraint/ConstraintSet.class
