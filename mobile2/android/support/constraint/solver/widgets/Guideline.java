...
public class Guideline extends ConstraintWidget {
  ...
  public Rectangle getHead() {
    ...
    if (getOrientation() == 0) {
      ...
      i = getDrawY();
      k = this.mHeadSize;
      rectangle.setBounds(j - m * 2, i - k, k * 2, k * 2);
    } 
    return this.mHead;
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/constraint/solver/widgets/Guideline.class
