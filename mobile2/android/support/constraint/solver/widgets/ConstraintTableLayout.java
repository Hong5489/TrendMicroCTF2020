...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
  ...
  private void setChildrenConnections() {
    ...
    for (byte b = 0; b < i; b++) {
      ...
      VerticalSlice verticalSlice = this.mVerticalSlices.get(j % k);
  ...
  public void cycleColumnAlignment(int paramInt) {
    ...
    paramInt = verticalSlice.alignment;
    if (paramInt != 0) {
      if (paramInt != 1) {
        if (paramInt == 2)
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/constraint/solver/widgets/ConstraintTableLayout.class
