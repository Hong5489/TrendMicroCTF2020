    ...
    while (i != 1 && (paramXmlPullParser.getDepth() >= j + 1 || i != 3)) {
      if (i == 2) {
        ...
        if ("animated-vector".equals(str)) {
          ...
          if (i != 0) {
            vectorDrawableCompat = VectorDrawableCompat.create(paramResources, i, paramTheme);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/graphics/drawable/AnimatedVectorDrawableCompat.class
