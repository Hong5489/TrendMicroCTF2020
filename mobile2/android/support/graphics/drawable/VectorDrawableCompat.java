...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  private void inflateInternal(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme) throws XmlPullParserException, IOException {
    ...
    while (i != 1 && (paramXmlPullParser.getDepth() >= j + 1 || i != 3)) {
      if (i == 2) {
        ...
        } else if ("group".equals(vClipPath)) {
  ...
  private void printGroupTree(VGroup paramVGroup, int paramInt) {
    ...
    for (b = 0; b < paramVGroup.mChildren.size(); b++) {
      VObject vObject = paramVGroup.mChildren.get(b);
  ...
  public boolean isStateful() {
    ...
    if (!super.isStateful()) {
      VectorDrawableCompatState vectorDrawableCompatState = this.mVectorState;
      return (vectorDrawableCompatState != null && (vectorDrawableCompatState.isStateful() || (this.mVectorState.mTint != null && this.mVectorState.mTint.isStateful())));
    } 
    return true;
  }
  ...
  private static class VFullPath extends VPath {
    ...
    public boolean onStateChanged(int[] param1ArrayOfint) {
      return this.mFillColor.onStateChanged(param1ArrayOfint) | this.mStrokeColor.onStateChanged(param1ArrayOfint);
    }
    ...
    private void drawPath(VectorDrawableCompat.VGroup param1VGroup, VectorDrawableCompat.VPath param1VPath, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      if (param1VPath.isClipPath()) {
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathStart != 0.0F || ((VectorDrawableCompat.VFullPath)param1VPath).mTrimPathEnd != 1.0F) {
          ...
          f1 = this.mPathMeasure.getLength();
          f4 = (f4 + f5) % 1.0F * f1;
          f7 = (f6 + f7) % 1.0F * f1;
          path.reset();
          if (f4 > f7) {
            this.mPathMeasure.getSegment(f4, f1, path, true);
        ...
        if (((VectorDrawableCompat.VFullPath)param1VPath).mStrokeColor.willDraw()) {
          ...
          paint.setColorFilter(param1ColorFilter);
          paint.setStrokeWidth(((VectorDrawableCompat.VFullPath)param1VPath).mStrokeWidth * f3 * f2);
          param1Canvas.drawPath(this.mRenderPath, paint);
        } 
      } 
    }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/graphics/drawable/VectorDrawableCompat.class
