...
public class ChangeTransform extends Transition {
  ...
  public ChangeTransform(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    this.mUseOverlay = TypedArrayUtils.getNamedBoolean(typedArray, (XmlPullParser)paramAttributeSet, "reparentWithOverlay", 1, true);
    this.mReparent = TypedArrayUtils.getNamedBoolean(typedArray, (XmlPullParser)paramAttributeSet, "reparent", 0, true);
    typedArray.recycle();
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/transition/ChangeTransform.class
