    ...
    if (i == 1073741824) {
      if (View.MeasureSpec.getMode(paramInt2) != 0) {
        ...
        if (view1 != null) {
          ...
          this.mCustomView.measure(View.MeasureSpec.makeMeasureSpec(paramInt2, paramInt1), View.MeasureSpec.makeMeasureSpec(j, i1));
        } 
        if (this.mContentHeight <= 0) {
          i = 0;
          j = getChildCount();
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/ActionBarContextView.class
