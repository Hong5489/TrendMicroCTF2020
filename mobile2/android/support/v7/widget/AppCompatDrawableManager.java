...
public final class AppCompatDrawableManager {
  ...
  private ColorStateList createSwitchThumbColorStateList(Context paramContext) {
    ...
    if (colorStateList != null && colorStateList.isStateful()) {
      ...
      arrayOfInt[++i] = ThemeUtils.EMPTY_STATE_SET;
      arrayOfInt1[i] = colorStateList.getDefaultColor();
    } else {
      arrayOfInt[0] = ThemeUtils.DISABLED_STATE_SET;
  ...
  private Drawable tintDrawable(Context paramContext, int paramInt, boolean paramBoolean, Drawable paramDrawable) {
    ...
    if (colorStateList != null) {
      ...
      drawable = DrawableCompat.wrap(drawable1);
      ...
      drawable = paramDrawable;
      if (!tintDrawableUsingColorFilter((Context)mode, paramInt, paramDrawable)) {
        drawable = paramDrawable;
        if (paramBoolean)
          drawable = null; 
      } 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/AppCompatDrawableManager.class
