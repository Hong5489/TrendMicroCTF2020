...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (paramInt1 = 0; paramInt1 < paramInt4; paramInt1++) {
      ...
      if (view.getVisibility() != 8) {
        ...
        int k = layoutParams.leftMargin + paramInt2;
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    int j = Math.max(0, this.mActionBarTop.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
    int k = Math.max(0, this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
    ...
    i = Math.max(j, this.mContent.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
    int i1 = Math.max(k, this.mContent.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
    int n = View.combineMeasuredStates(m, this.mContent.getMeasuredState());
    m = getPaddingLeft();
    k = getPaddingRight();
    i1 = Math.max(i1 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight());
    i = Math.max(i + m + k, getSuggestedMinimumWidth());
    setMeasuredDimension(View.resolveSizeAndState(i, paramInt1, n), View.resolveSizeAndState(i1, paramInt2, n << 16));
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/ActionBarOverlayLayout.class
