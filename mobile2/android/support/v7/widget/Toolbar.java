...
public class Toolbar extends ViewGroup {
  ...
  public Toolbar(Context paramContext, AttributeSet paramAttributeSet, int paramInt) {
    ...
    int j = tintTypedArray.getDimensionPixelOffset(R.styleable.Toolbar_contentInsetEnd, -2147483648);
    ...
    ensureContentInsets();
    this.mContentInsets.setAbsolute(i, k);
  ...
  private int layoutChildRight(View paramView, int paramInt1, int[] paramArrayOfint, int paramInt2) {
    ...
    return paramInt1 - layoutParams.leftMargin + paramInt2;
  }
  ...
  private int measureChildCollapseMargins(View paramView, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[] paramArrayOfint) {
    ...
    paramInt1 = getChildMeasureSpec(paramInt1, getPaddingLeft() + getPaddingRight() + k + paramInt2, marginLayoutParams.width);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
      ...
      if (i2 != 48) {
        if (i2 != 80) {
          ...
          if (i2 < layoutParams1.topMargin + this.mTitleMarginTop) {
            ...
            k = k - i1 - paramInt1 - i2 - n;
            paramInt1 = i2;
            if (k < layoutParams1.bottomMargin + this.mTitleMarginBottom)
              paramInt1 = Math.max(0, i2 - layoutParams2.bottomMargin + this.mTitleMarginBottom - k); 
          } 
    ...
    for (paramInt2 = 0; paramInt2 < i; paramInt2++)
      i4 = layoutChildRight(this.mTempViews.get(paramInt2), i4, arrayOfInt, paramInt4); 
    addCustomViewsWithGravity(this.mTempViews, 1);
    i = getViewListMeasuredWidth(this.mTempViews, arrayOfInt);
    paramInt2 = i3 + (j - i3 - m) / 2 - i / 2;
    i3 = i + paramInt2;
    if (paramInt2 >= paramInt1)
      if (i3 > i4) {
        paramInt1 = paramInt2 - i3 - i4;
      } else {
        paramInt1 = paramInt2;
      }  
    i4 = this.mTempViews.size();
    for (paramInt2 = paramInt3; paramInt2 < i4; paramInt2++)
      paramInt1 = layoutChildLeft(this.mTempViews.get(paramInt2), paramInt1, arrayOfInt, paramInt4); 
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    if (shouldLayout((View)this.mCollapseButtonView)) {
      ...
      i1 = Math.max(i, this.mCollapseButtonView.getMeasuredHeight() + getVerticalMargins((View)this.mCollapseButtonView));
      i2 = View.combineMeasuredStates(j, this.mCollapseButtonView.getMeasuredState());
    } 
    j = getCurrentContentInsetStart();
    i = 0 + Math.max(j, n);
    arrayOfInt[k] = Math.max(0, j - n);
    if (shouldLayout((View)this.mMenuView)) {
      measureChildConstrained((View)this.mMenuView, paramInt1, i, paramInt2, 0, this.mMaxButtonHeight);
      j = this.mMenuView.getMeasuredWidth();
      n = getHorizontalMargins((View)this.mMenuView);
      i1 = Math.max(i1, this.mMenuView.getMeasuredHeight() + getVerticalMargins((View)this.mMenuView));
      i2 = View.combineMeasuredStates(i2, this.mMenuView.getMeasuredState());
      j += n;
    } else {
      j = 0;
    } 
    ...
    i += Math.max(n, j);
    arrayOfInt[m] = Math.max(0, n - j);
    if (shouldLayout(this.mExpandedActionView)) {
      m = i + measureChildCollapseMargins(this.mExpandedActionView, paramInt1, i, paramInt2, 0, arrayOfInt);
      j = Math.max(i1, this.mExpandedActionView.getMeasuredHeight() + getVerticalMargins(this.mExpandedActionView));
      i2 = View.combineMeasuredStates(i2, this.mExpandedActionView.getMeasuredState());
    } else {
      j = i1;
      m = i;
    } 
    ...
    if (shouldLayout((View)this.mLogoView)) {
      ...
      n = View.combineMeasuredStates(i2, this.mLogoView.getMeasuredState());
    } 
    j = getChildCount();
    i2 = n;
    int m = 0;
    ...
    for (i1 = m; i1 < j; i1++) {
      ...
      if (((LayoutParams)view.getLayoutParams()).mViewType == 0 && shouldLayout(view)) {
        i += measureChildCollapseMargins(view, paramInt1, i, paramInt2, 0, arrayOfInt);
    ...
    int k = this.mTitleMarginStart + this.mTitleMarginEnd;
    i1 = m;
    if (shouldLayout((View)this.mTitleTextView)) {
      measureChildCollapseMargins((View)this.mTitleTextView, paramInt1, i + k, paramInt2, i3, arrayOfInt);
      j = this.mTitleTextView.getMeasuredWidth() + getHorizontalMargins((View)this.mTitleTextView);
      i2 = this.mTitleTextView.getMeasuredHeight() + getVerticalMargins((View)this.mTitleTextView);
      i1 = View.combineMeasuredStates(m, this.mTitleTextView.getMeasuredState());
    } 
    if (shouldLayout((View)this.mSubtitleTextView)) {
      j = Math.max(j, measureChildCollapseMargins((View)this.mSubtitleTextView, paramInt1, i + k, paramInt2, i2 + i3, arrayOfInt));
      m = this.mSubtitleTextView.getMeasuredHeight();
      k = getVerticalMargins((View)this.mSubtitleTextView);
      i1 = View.combineMeasuredStates(i1, this.mSubtitleTextView.getMeasuredState());
      i2 += m + k;
    } 
    n = Math.max(n, i2);
    i3 = getPaddingLeft();
    ...
    m = getPaddingTop();
    i2 = getPaddingBottom();
    j = View.resolveSizeAndState(Math.max(i + j + i3 + k, getSuggestedMinimumWidth()), paramInt1, 0xFF000000 & i1);
    paramInt1 = View.resolveSizeAndState(Math.max(n + m + i2, getSuggestedMinimumHeight()), paramInt2, i1 << 16);
    if (shouldCollapse())
      paramInt1 = 0; 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/Toolbar.class
