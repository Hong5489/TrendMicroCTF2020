...
public class ToolbarWidgetWrapper implements DecorToolbar {
  ...
  public ToolbarWidgetWrapper(Toolbar paramToolbar, boolean paramBoolean, int paramInt1, int paramInt2) {
    ...
    if (paramBoolean) {
      ...
      int i = tintTypedArray.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetStart, -1);
      paramInt2 = tintTypedArray.getDimensionPixelOffset(R.styleable.ActionBar_contentInsetEnd, -1);
      if (i >= 0 || paramInt2 >= 0)
        this.mToolbar.setContentInsetsRelative(Math.max(i, 0), Math.max(paramInt2, 0)); 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/ToolbarWidgetWrapper.class
