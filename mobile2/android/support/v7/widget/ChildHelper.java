...
class ChildHelper {
  ...
  static class Bucket {
    ...
    boolean remove(int param1Int) {
      ...
      this.mData = l2;
      l1--;
      this.mData = l2 & l1 | Long.rotateRight(l2 & l1, 1);
      Bucket bucket = this.mNext;
      if (bucket != null) {
        if (bucket.get(0))
          set(63); 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/ChildHelper.class
