  ...
  public void runPendingAnimations() {
    ...
    if (m != 0) {
      ...
      if (i != 0 || j != 0 || k != 0) {
        ...
        ViewCompat.postOnAnimationDelayed(((RecyclerView.ViewHolder)arrayList.get(0)).itemView, runnable, l3 + l2);
        return;
      } 
      runnable.run();
    } 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/DefaultItemAnimator.class
