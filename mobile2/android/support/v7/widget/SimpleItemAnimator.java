...
public abstract class SimpleItemAnimator extends RecyclerView.ItemAnimator {
  ...
  public boolean animateChange(RecyclerView.ViewHolder paramViewHolder1, RecyclerView.ViewHolder paramViewHolder2, RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo1, RecyclerView.ItemAnimator.ItemHolderInfo paramItemHolderInfo2) {
    ...
    if (paramViewHolder2.shouldIgnore()) {
      ...
      int n = paramItemHolderInfo1.top;
      m = k;
      k = n;
    } else {
      int n = paramItemHolderInfo2.left;
      k = paramItemHolderInfo2.top;
      m = n;
    } 
    return animateChange(paramViewHolder1, paramViewHolder2, i, j, m, k);
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/SimpleItemAnimator.class
