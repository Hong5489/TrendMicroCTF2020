  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    if (!(IMPL instanceof CardViewApi21Impl)) {
      ...
      if (i == Integer.MIN_VALUE || i == 1073741824) {
        int j = (int)Math.ceil(IMPL.getMinWidth(this.mCardViewDelegate));
        paramInt1 = View.MeasureSpec.makeMeasureSpec(Math.max(j, View.MeasureSpec.getSize(paramInt1)), i);
      } 
      i = View.MeasureSpec.getMode(paramInt2);
      if (i == Integer.MIN_VALUE || i == 1073741824) {
        int j = (int)Math.ceil(IMPL.getMinHeight(this.mCardViewDelegate));
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/CardView.class
