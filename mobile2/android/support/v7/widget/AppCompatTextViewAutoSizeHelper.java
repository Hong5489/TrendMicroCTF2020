...
class AppCompatTextViewAutoSizeHelper {
  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (typedArray.hasValue(R.styleable.AppCompatTextView_autoSizeMinTextSize))
      f1 = typedArray.getDimension(R.styleable.AppCompatTextView_autoSizeMinTextSize, -1.0F); 
    ...
    if (supportsAutoSizeText()) {
      if (this.mAutoSizeTextType == 1) {
        if (!this.mHasPresetAutoSizeValues) {
          ...
          f1 = f2;
          if (f2 == -1.0F)
            f1 = TypedValue.applyDimension(2, 112.0F, displayMetrics); 
          f2 = f3;
          if (f3 == -1.0F)
            f2 = 1.0F; 
          validateAndSetAutoSizeTextTypeUniformConfiguration(f, f1, f2);
        } 
        setupAutoSizeText();
      } 
    } else {
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/AppCompatTextViewAutoSizeHelper.class
