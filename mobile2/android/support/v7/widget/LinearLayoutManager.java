...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
  ...
  void layoutChunk(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, LayoutState paramLayoutState, LayoutChunkResult paramLayoutChunkResult) {
    ...
    layoutDecoratedWithMargins(view, k, m, j, i);
    ...
    if (paramState.isPreLayout()) {
      ...
      if (i1 != -1) {
        ...
        if (this.mPendingScrollPositionOffset != Integer.MIN_VALUE) {
          ...
          if (view != null) {
            if (this.mShouldReverseLayout) {
              j = this.mOrientationHelper.getEndAfterPadding() - this.mOrientationHelper.getDecoratedEnd(view) - this.mPendingScrollPositionOffset;
            } else {
    ...
    public void assignFromViewAndKeepVisibleRect(View param1View, int param1Int) {
      ...
      if (this.mLayoutFromEnd) {
        ...
        if (param1Int > 0) {
          ...
          i = this.mOrientationHelper.getEndAfterPadding() - Math.min(0, n - i - k) - m + j;
          if (i < 0)
            this.mCoordinate -= Math.min(param1Int, -i); 
        } 
      } 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/LinearLayoutManager.class
