  ...
  void loadFromAttributes(AttributeSet paramAttributeSet, int paramInt) {
    ...
    if (i != -1) {
      ...
      if (Build.VERSION.SDK_INT < 23) {
        ...
        if (tintTypedArray.hasValue(R.styleable.TextAppearance_android_textColorHint))
          colorStateList4 = tintTypedArray.getColorStateList(R.styleable.TextAppearance_android_textColorHint); 
    ...
    if (Build.VERSION.SDK_INT < 23) {
      if (tintTypedArray3.hasValue(R.styleable.TextAppearance_android_textColor))
        colorStateList1 = tintTypedArray3.getColorStateList(R.styleable.TextAppearance_android_textColor); 
      if (tintTypedArray3.hasValue(R.styleable.TextAppearance_android_textColorHint))
        colorStateList2 = tintTypedArray3.getColorStateList(R.styleable.TextAppearance_android_textColorHint); 
      colorStateList4 = colorStateList1;
      colorStateList6 = colorStateList2;
      colorStateList3 = colorStateList5;
    ...
    k = tintTypedArray1.getDimensionPixelSize(R.styleable.AppCompatTextView_firstBaselineToTopHeight, -1);
    j = tintTypedArray1.getDimensionPixelSize(R.styleable.AppCompatTextView_lastBaselineToBottomHeight, -1);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/widget/AppCompatTextHelper.class
