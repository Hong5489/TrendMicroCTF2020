    ...
    while (true) {
      ...
      if (j != 1) {
        ...
        if (k >= i || j != 3) {
          ...
          if (k > 0)
            drawable1 = AppCompatResources.getDrawable(paramContext, k); 
          typedArray.recycle();
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/graphics/drawable/StateListDrawable.class
