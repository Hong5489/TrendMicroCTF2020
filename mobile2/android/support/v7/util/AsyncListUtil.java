...
public class AsyncListUtil<T> {
  ...
  void updateRange() {
    ...
    arrayOfInt1 = this.mPrevRange;
    int[] arrayOfInt2 = this.mTmpRange;
    arrayOfInt1[0] = arrayOfInt2[0];
    arrayOfInt1[1] = arrayOfInt2[1];
    this.mViewCallback.extendRangeInto(arrayOfInt2, this.mTmpRangeExtended, this.mScrollHint);
    arrayOfInt2 = this.mTmpRangeExtended;
    arrayOfInt2[0] = Math.min(this.mTmpRange[0], Math.max(arrayOfInt2[0], 0));
    arrayOfInt2 = this.mTmpRangeExtended;
    arrayOfInt2[1] = Math.max(this.mTmpRange[1], Math.min(arrayOfInt2[1], this.mItemCount - 1));
    ThreadUtil.BackgroundCallback<T> backgroundCallback = this.mBackgroundProxy;
  ...
  public static abstract class ViewCallback {
    ...
    public void extendRangeInto(int[] param1ArrayOfint1, int[] param1ArrayOfint2, int param1Int) {
      ...
      param1ArrayOfint2[1] = m + param1Int;
    }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/util/AsyncListUtil.class
