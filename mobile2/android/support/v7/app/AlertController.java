...
class AlertController {
  ...
  private void setupView() {
    ...
    if (listView1 instanceof RecycleListView)
      ((RecycleListView)listView1).setHasDecor(bool1, bool2); 
    if (!i) {
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v7/app/AlertController.class
