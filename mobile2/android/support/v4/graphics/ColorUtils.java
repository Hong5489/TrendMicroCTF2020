  ...
  public static Color compositeColors(Color paramColor1, Color paramColor2) {
    if (Objects.equals(paramColor1.getModel(), paramColor2.getModel())) {
      ...
      if (arrayOfFloat2[i] > 0.0F) {
        f3 = f1 / arrayOfFloat2[i];
        f4 = f2 / arrayOfFloat2[i];
      } 
      for (byte b = 0; b < i; b++)
        arrayOfFloat2[b] = arrayOfFloat1[b] * f3 + arrayOfFloat2[b] * f4; 
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/graphics/ColorUtils.class
