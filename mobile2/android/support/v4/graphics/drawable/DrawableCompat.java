    ...
    if (Build.VERSION.SDK_INT >= 23) {
      ...
      if (Build.VERSION.SDK_INT >= 21) {
        ...
        if (paramDrawable instanceof InsetDrawable) {
          ...
          DrawableContainer drawableContainer = (DrawableContainer)paramDrawable;
          drawableContainerState = (DrawableContainer.DrawableContainerState)drawableContainer.getConstantState();
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/graphics/drawable/DrawableCompat.class
