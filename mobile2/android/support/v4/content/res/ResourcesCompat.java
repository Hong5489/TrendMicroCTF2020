        ...
        if (bool) {
          try {
            ...
            if (familyResourceEntry == null) {
              ...
              try {
                return TypefaceCompat.createFromResourcesFamilyXml((Context)iOException, familyResourceEntry, paramResources, paramInt1, paramInt2, paramFontCallback, paramHandler, paramBoolean);
              } catch (XmlPullParserException xmlPullParserException) {
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/content/res/ResourcesCompat.class
