...
final class GradientColorInflaterCompat {
  ...
  static Shader createFromXmlInner(Resources paramResources, XmlPullParser paramXmlPullParser, AttributeSet paramAttributeSet, Resources.Theme paramTheme) throws IOException, XmlPullParserException {
    ...
    if (str.equals("gradient")) {
      ...
      if (i != 1)
        return (Shader)((i != 2) ? new LinearGradient(f1, f2, f3, f4, colorStops.mColors, colorStops.mOffsets, parseTileMode(n)) : new SweepGradient(f5, f6, colorStops.mColors, colorStops.mOffsets)); 
      if (f7 > 0.0F)
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/content/res/GradientColorInflaterCompat.class
