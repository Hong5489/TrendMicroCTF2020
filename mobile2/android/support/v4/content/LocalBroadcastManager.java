...
public final class LocalBroadcastManager {
  ...
  void executePendingBroadcasts() {
    while (true) {
      ...
      /* monitor enter ClassFileLocalVariableReferenceExpression{type=ObjectType{java/util/HashMap<[ObjectType{android/content/BroadcastReceiver}, ObjectType{java/util/ArrayList<InnerObjectType{ObjectType{android/support/v4/content/LocalBroadcastManager}.Landroid/support/v4/content/LocalBroadcastManager$ReceiverRecord;}>}]>}, name=null} */
      try {
        int i = this.mPendingBroadcasts.size();
        if (i <= 0) {
          /* monitor exit ClassFileLocalVariableReferenceExpression{type=ObjectType{java/util/HashMap<[ObjectType{android/content/BroadcastReceiver}, ObjectType{java/util/ArrayList<InnerObjectType{ObjectType{android/support/v4/content/LocalBroadcastManager}.Landroid/support/v4/content/LocalBroadcastManager$ReceiverRecord;}>}]>}, name=null} */
          return;
        } 
      ...
      /* monitor exit ClassFileLocalVariableReferenceExpression{type=InnerObjectType{ObjectType{android/support/v4/content/LocalBroadcastManager}.Landroid/support/v4/content/LocalBroadcastManager$ReceiverRecord;}, name=null} */
      throw exception;
    } 
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/content/LocalBroadcastManager.class
