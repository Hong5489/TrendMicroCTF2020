...
public final class ArraySet<E> implements Collection<E>, Set<E> {
  ...
  public boolean add(E paramE) {
    ...
    if (k < j) {
      ...
      System.arraycopy(arrayOfInt, k, arrayOfInt, k + 1, j - k);
      Object[] arrayOfObject = this.mArray;
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/util/ArraySet.class
