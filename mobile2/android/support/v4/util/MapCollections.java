...
abstract class MapCollections<K, V> {
  ...
  final class EntrySet implements Set<Map.Entry<K, V>> {
    ...
    public int hashCode() {
      ...
      for (int j = MapCollections.this.colGetSize() - 1; j >= 0; j--) {
        ...
        int k = 0;
        Object object1 = mapCollections.colGetEntry(j, 0);
  ...
  final class KeySet implements Set<K> {
    ...
    public int hashCode() {
      ...
      for (int j = MapCollections.this.colGetSize() - 1; j >= 0; j--) {
        MapCollections mapCollections = MapCollections.this;
        int k = 0;
        Object object = mapCollections.colGetEntry(j, 0);
        if (object != null)
          k = object.hashCode(); 
        i += k;
      } 
    ...
    public Iterator<K> iterator() {
      return new MapCollections.ArrayIterator<>(0);
    }
  ...
  final class ValuesCollection implements Collection<V> {
    ...
    public Iterator<V> iterator() {
      return new MapCollections.ArrayIterator<>(1);
    }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/util/MapCollections.class
