  ...
  private static class OreoCallback implements ActionMode.Callback {
    ...
    private boolean isSupportedActivity(ResolveInfo param1ResolveInfo, Context param1Context) {
      ...
      if (!param1ResolveInfo.activityInfo.exported)
        return false; 
      if (param1ResolveInfo.activityInfo.permission != null && param1Context.checkSelfPermission(param1ResolveInfo.activityInfo.permission) != 0)
        bool1 = false; 
      return bool1;
    }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/widget/TextViewCompat.class
