...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private float computeTargetVelocity(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    paramFloat1 = this.mMaximumVelocity[paramInt];
    paramFloat3 = f2 * paramFloat3;
    return (f1 > 0.0F) ? constrain(f1 * paramFloat3, paramFloat2, paramFloat1) : -constrain(-f1 * paramFloat3, paramFloat2, paramFloat1);
  }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
