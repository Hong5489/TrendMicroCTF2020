...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private void moveSpinner(float paramFloat) {
    ...
    float f5 = i;
    f4 = Math.max(0.0F, Math.min(f3 - f4, f5 * 2.0F) / f5);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    paramInt4 = this.mCircleView.getMeasuredWidth();
    paramInt3 = this.mCircleView.getMeasuredHeight();
    CircleImageView circleImageView = this.mCircleView;
    int i = paramInt1 / 2;
    paramInt2 = paramInt4 / 2;
    int j = this.mCurrentTargetOffsetTop;
    circleImageView.layout(i - paramInt2, j, paramInt1 / 2 + paramInt4 / 2, j + paramInt3);
  }
    ...
    if (paramInt2 > 0) {
      ...
      if (f > 0.0F) {
        if (paramInt2 > f) {
          ...
          this.mTotalUnconsumed = f - paramInt2;
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/widget/SwipeRefreshLayout.class
