...
class CircleImageView extends ImageView {
  ...
  private class OvalShadow extends OvalShape {
    ...
    private void updateRadialGradient(int param1Int) {
      ...
      RadialGradient radialGradient = new RadialGradient(f1, f2, f3, new int[] { 1023410176, 0 }, null, tileMode);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/widget/CircleImageView.class
