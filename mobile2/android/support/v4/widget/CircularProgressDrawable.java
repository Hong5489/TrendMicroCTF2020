...
public class CircularProgressDrawable extends Drawable implements Animatable {
  ...
  void applyTransformation(float paramFloat, Ring paramRing, boolean paramBoolean) {
    if (this.mFinishing) {
      ...
      if (paramFloat < 0.5F) {
        ...
        float f = MATERIAL_INTERPOLATOR.getInterpolation(f3);
        f3 = f2;
        f = f2 - (1.0F - f) * 0.79F + 0.01F;
        f2 = f3;
        f3 = f;
      } 
      ...
      setRotation((f4 + paramFloat) * 216.0F);
    } 
  }
  ...
  private static class Ring {
    ...
    void draw(Canvas param1Canvas, Rect param1Rect) {
      ...
      f1 = this.mRotation;
      f2 = (f2 + f1) * 360.0F;
      float f3 = (this.mEndTrim + f1) * 360.0F - f2;
      this.mPaint.setColor(this.mCurrentColor);
      this.mPaint.setAlpha(this.mAlpha);
      f1 = this.mStrokeWidth / 2.0F;
      rectF.inset(f1, f1);
      param1Canvas.drawCircle(rectF.centerX(), rectF.centerY(), rectF.width() / 2.0F, this.mCirclePaint);
      rectF.inset(-f1, -f1);
      param1Canvas.drawArc(rectF, f2, f3, false, this.mPaint);
      drawTriangle(param1Canvas, f2, f3, rectF);
    }
    ...
    void drawTriangle(Canvas param1Canvas, float param1Float1, float param1Float2, RectF param1RectF) {
      if (this.mShowArrow) {
        ...
        this.mArrow.offset(param1RectF.centerX() + f1 - f2, param1RectF.centerY() + this.mStrokeWidth / 2.0F);
        this.mArrow.close();
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/widget/CircularProgressDrawable.class
