...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
  ...
  boolean interactsWith(ArrayList<BackStackRecord> paramArrayList, int paramInt1, int paramInt2) {
    ...
    while (b1 < i) {
      byte b2;
      Op op = this.mOps.get(b1);
      if (op.fragment != null) {
        b2 = op.fragment.mContainerId;
      } else {
        b2 = 0;
      } 
      byte b3 = b;
        ...
        if (b2 != b) {
          ...
          while (true) {
            ...
            if (j < paramInt2) {
              ...
              for (b3 = 0; b3 < k; b3++) {
                byte b4;
                Op op1 = backStackRecord.mOps.get(b3);
                if (op1.fragment != null) {
                  b4 = op1.fragment.mContainerId;
                } else {
                  b4 = 0;
                } 
                if (b4 == b2)
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/app/BackStackRecord.class
