...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
  ...
  private class SlideDrawable extends InsetDrawable implements Drawable.Callback {
    ...
    public void draw(Canvas param1Canvas) {
      ...
      param1Canvas.translate(-this.mOffset * j * this.mPosition * b, 0.0F);
      if (i != 0 && !this.mHasMirroring) {
        param1Canvas.translate(j, 0.0F);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/app/ActionBarDrawerToggle.class
