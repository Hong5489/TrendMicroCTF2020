...
class LoaderManagerImpl extends LoaderManager {
  ...
  public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
    ...
    Loader<D> setCallback(LifecycleOwner param1LifecycleOwner, LoaderManager.LoaderCallbacks<D> param1LoaderCallbacks) {
      LoaderManagerImpl.LoaderObserver<D> loaderObserver2 = new LoaderManagerImpl.LoaderObserver<>(this.mLoader, param1LoaderCallbacks);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/app/LoaderManagerImpl.class
