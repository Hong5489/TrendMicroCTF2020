...
public class AccessibilityNodeInfoCompat {
  ...
  private void setBooleanProperty(int paramInt, boolean paramBoolean) {
    ...
    if (bundle != null) {
      ...
      if (paramBoolean)
        i = paramInt; 
      bundle.putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", i | j & paramInt);
    } 
  }
  ...
  public static class AccessibilityActionCompat {
    ...
    static {
      ...
      ACTION_MOVE_WINDOW = new AccessibilityActionCompat(accessibilityAction2);
      if (Build.VERSION.SDK_INT >= 28) {
        accessibilityAction2 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TOOLTIP;
      } else {
        accessibilityAction2 = null;
      } 
      ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(accessibilityAction2);
      ...
      ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(accessibilityAction2);
    }
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/view/accessibility/AccessibilityNodeInfoCompat.class
