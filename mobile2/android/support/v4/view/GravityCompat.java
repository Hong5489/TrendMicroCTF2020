...
public final class GravityCompat {
  ...
  public static int getAbsoluteGravity(int paramInt1, int paramInt2) {
    return (Build.VERSION.SDK_INT >= 17) ? Gravity.getAbsoluteGravity(paramInt1, paramInt2) : (0xFF7FFFFF & paramInt1);
  }
}


/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/view/GravityCompat.class
