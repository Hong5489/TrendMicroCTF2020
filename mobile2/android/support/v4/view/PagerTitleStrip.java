...
public class PagerTitleStrip extends ViewGroup {
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean) {
    ...
    i8 = Math.max(Math.max(i6 + i9, j + i8), i7 + i10);
    ...
    textView.layout(m, j, i5, j + textView.getMeasuredHeight());
    j = Math.min(i2, m - this.mScaledTextSpacing - i);
    textView = this.mPrevText;
    textView.layout(j, i4, j + i, i4 + textView.getMeasuredHeight());
    i4 = Math.max(n - i3 - k, this.mScaledTextSpacing + i5);
    textView = this.mNextText;
    textView.layout(i4, paramInt, i4 + k, paramInt + textView.getMeasuredHeight());
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/view/PagerTitleStrip.class
