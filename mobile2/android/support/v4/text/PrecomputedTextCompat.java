...
public class PrecomputedTextCompat implements Spannable {
  ...
  private int findParaIndex(int paramInt) {
    ...
    while (true) {
      ...
      arrayOfInt = this.mParagraphEnds;
  ...
  public static final class Params {
    ...
    public boolean equals(Object param1Object) {
      ...
      if (param1Object == null || !(param1Object instanceof Params))
        return false; 
      Params params = (Params)param1Object;
      param1Object = this.mWrapped;
      if (param1Object != null)
        return param1Object.equals(params.mWrapped); 
      if (Build.VERSION.SDK_INT >= 23) {
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/text/PrecomputedTextCompat.class
