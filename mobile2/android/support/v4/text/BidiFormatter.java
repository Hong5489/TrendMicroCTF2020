...
public final class BidiFormatter {
  ...
  private static class DirectionalityEstimator {
    ...
    int getEntryDir() {
      ...
      byte b = 0;
      byte b2;
      for (b2 = 0; this.charIndex < this.length && !b2; b2 = b1) {
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/android/support/v4/text/BidiFormatter.class
