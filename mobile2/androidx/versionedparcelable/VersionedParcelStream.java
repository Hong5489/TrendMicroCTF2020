  ...
  public boolean readField(int paramInt) {
    ...
    try {
      while (true) {
        ...
        this(0xFFFF & i >> 16, k, this.mMasterInput);
...
/* Location:              /root/Downloads/trendmicro/mobile2/test/classes-dex2jar.jar!/androidx/versionedparcelable/VersionedParcelStream.class
